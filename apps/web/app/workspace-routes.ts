...
export const workspaceRoutes = [
  ...
  { path: "/app/discovery", label: "Discovery", nav: true },
  ...
  { path: "/app/catalog/:catalogId", label: "Catalog Details", nav: false, parent: "/app/catalog" },
  { path: "/app/catalog/new", label: "New Catalog", screenId: "UI-BLUEPRINT-SCREEN-008", nav: false, parent: "/app/catalog" },
  ...
  { path: "/app/settings/workspace", label: "Workspace Settings", nav: false, parent: "/app/settings" },
